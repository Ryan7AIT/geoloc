...
@Component({
  selector: 'app-realtimespeed',
  standalone: true,
  imports: [],
  templateUrl: './realtimespeed.component.html',
  styleUrl: './realtimespeed.component.css'
})
export class RealtimespeedComponent {
  ...
  createChart() {
    ...
    this.chart = new Chart('MyChart11', {
      type: 'line',
      data: {
